    ...
    <div class="container">
        <div class="row featurette">
            <div class="col-sm-12 col-md-7 col-lg-7">
                ...
                <p class="lead">EdiPhotos was started in Toronto in 2000 by owner and photographer Paco Johnson. As a photographer, Paco
                    knew of the struggles of commercializing travel photography, as well as the demand for high-quality magazine-style travel photographs.
                    He launched EdiPhotos as a small agency in Toronto, with the mission to provide premium unique photographs to high-end magazines all over
                    North America and to link exceptional photographers with mediums where their work would be appreciated.
                </p>
                <p class="lead" >Today, EdiPhotos is the go-to photo studio and agency for all high-end travel magazines worldwide, from Conde Nast to International Traveller.
                They have specialist photographers based in Asia and South America specifically, where they local knowledge and expertise allow them to 
                provide cutting-edge images on demand. EdiPhotos photographers can be commissioned to do photo shoots in multiple locations on these continents
                on client request.
                </p>
            </div>
            <div class="col-sm-12 col-md-5 col-lg-5">
                <img class="featurette-image img-responsive center-block" src="img/america-500.jpg" alt="The Grand Canyon">
            </div>
        </div>
        <!-- long-image header -->
        ...
        <div class="row featurette photographer-feature">
            <div class="col-sm-12 col-md-7 col-lg-7">
                <h2 class="featurette-heading">Our Photographers</h2>
                <p class="lead">EdiPhotos connects magazines with award-winning photographers. Our photographers are country-specialists and
                    are artists at the height of their craft. From award-winning documentary photographers, to travel specialists, street photographers,
                     indoor interior photographers and commercial photographers - EdiPhotos has the photographer to bring across the specific look and message that your magazine is trying
                   to portray.
                </p>
            </div>
            <div class="col-sm-12 col-md-5 col-lg-5">
                <img class="featurette-image img-responsive center-block" src="img/seal-500.jpg" alt="A seal">
            </div>
        </div>
